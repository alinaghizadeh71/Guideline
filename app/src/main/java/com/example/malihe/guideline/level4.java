...
public class level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter1=new ListAdapter(level4.this, spannedStrings);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Toast.makeText(level4.this, String.valueOf(st),Toast.LENGTH_LONG).show();
                            ...
                            // Toast.makeText(level2.this,item,Toast.LENGTH_LONG).show();
                            int arryid = level4.this.getResources().getIdentifier(st, "array",
                                    level4.this.getPackageName());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            case R.id.Home:
                ...
                return true;
            case R.id.back:
               /* Intent ii=new Intent(level4.this,level3.class);
                startActivity(ii);*/
                this.finish();
                return true;
        }
