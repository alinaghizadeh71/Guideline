...
public class level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter1=new ListAdapter(level3.this, spannedStrings);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Toast.makeText(level2.this,item,Toast.LENGTH_LONG).show();
                int arryid = level3.this.getResources().getIdentifier(st, "array",
                        level3.this.getPackageName());



                if (arryid>0) {
                    // String[] termsArray  = level2.this.getResources().getStringArray(arryid);
                    //Toast.makeText(level3.this, String.valueOf(st),Toast.LENGTH_LONG).show();
                    //Toast.makeText(level3.this,String.valueOf(title+" -> "+item),Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(level3.this,"This list has not any sub item",Toast.LENGTH_LONG).show();
                }
